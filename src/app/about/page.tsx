...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "gajananpatange@gmail.com",
    href: "mailto:gajananpatange@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/gajanan-patange-820498259/",
    content: "/gajananpatange",
    icon: <FaLinkedin size={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/gajananhp13",
    content: "/gajananhp13",
    icon: <FaGithub size={"50px"} />,
  },
  {
    name: "LeetCode",
    href: "https://leetcode.com/u/gajananhp13/",
    content: "/gajananhp13",
    icon: <SiLeetcode size={"50px"} />,
  },
];
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Gajanan Patange</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Gajanan Patange, a Comp. Sci. Engineer with hands-on experience in Development, DevOps and
